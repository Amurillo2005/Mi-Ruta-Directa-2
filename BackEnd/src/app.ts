...
app.get("/api/search", async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        res.json({
            origen: { nombre: puntoOrigen.display_name, lat: parseFloat(puntoOrigen.lat), lon: parseFloat(puntoOrigen.lon) },
            destino: { nombre: puntoDestino.display_name, lat: parseFloat(puntoDestino.lat), lon: parseFloat(puntoDestino.lon) },
