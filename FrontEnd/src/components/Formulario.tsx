...
import type { FormularioProps } from "../interfaces/interfaces";

export const Formulario = ({ handleSubmit, direccionOrigen, setDireccionOrigen, direccionDestino, setDireccionDestino, ciudad, setCiudad }: FormularioProps) => {
  return (
